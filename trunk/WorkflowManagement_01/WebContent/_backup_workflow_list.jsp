...
<div id="workflow_list">
	...
	<s:form action="stage_mod.action" method="post" name="workflowMod" >
		<table  >
			...
			<display:table name="objListWfMaster" pagesize="1" sort="page" requestURI="EditWfAction.action">
  			<display:column property="workflowID" title="Workflow ID" />
  			<display:column property="workflowName" title="Workflow Name" />
  			<display:column property="workflowDescription" title="Workflow Description" />
  			<display:column property="workflowDomain" title="Workflow Domain"/>
  			<display:column value="Workflow Modification" title="Workflow Modifications" href="edit_wf.action" paramId="workflowID" paramProperty="workflowID"/>
  			<display:column title="Stage Modifications">
  			<a href="stage_mod.action?workflowID=<s:property value = "workflowID" />&pageName=workflow_list ">Stage Modifications </a>
  			</display:column>
			</display:table>
			</div>
			</div>
