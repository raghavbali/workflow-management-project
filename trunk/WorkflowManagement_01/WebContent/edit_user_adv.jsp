	...
	<div id="edit_user_adv">
		...
		<table>
			<s:form action="update_user_adv.action" method="post"
				onSubmit="return edit_user_adv(buttonIndex);">
				...
				<tr>
					...
					<td><s:select label="Select Workflow" list="wfList"
							name="w_id" value="%{tmpuser.getW_id()}" required="true" /></td>
				</tr>
				<tr>
					<td>Select Role</td>
					<td><s:select label="Select Role" list="roleList" name="role"
							value="%{tmpuser.getRole()}" required="true" /></td>
				</tr>
				<tr>
					<td>User Name</td>
					<td><s:textfield name="username" placeholder="username"
							id="username" label="User Name" value="%{tmpuser.getUsername()}"
							size="30" required="true" /></td>
				</tr>
				<tr>
					<td>Password</td>
					<td><s:textfield name="password" placeholder="password"
							id="password" label="Password" value="%{tmpuser.getPassword()}"
							size="30" required="true" /></td>
				</tr>
				<tr>
					<td>Select active state</td>
					<td><s:select label="Is active?" list="actstateList"
